...
const StepCard = ({ step }: StepCardProps) => {
    ...
    return (
        <div className={`relative flex flex-col gap-8 p-4 py-8 lg:py-24 lg:px-10 items-center lg:flex-row lg:justify-end xl:w-3/4 ${step.type === 1 ? "" : "lg:flex-row-reverse"} rounded-xl ${step.id == 1 ? "bg-blue" : step.id == 2 ? "bg-pink" : "bg-darkBlue"} text-white`}>
            ...
            <div className='lg:w-1/2 space-y-6 self-end'>
                {/* cirle div */}
